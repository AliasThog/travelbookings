		...
		<div class="main_container">
				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent.fdad3-2.fna.fbcdn.net/v/t1.6435-9/153851442_3754978591285691_1650931724252815520_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=eZ8Jgg3rGK0AX9QGmzW&_nc_ht=scontent.fdad3-2.fna&oh=8e6d44cc06dbc09c08984069ca599a78&oe=613FA2D3" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent.fdad3-2.fna.fbcdn.net/v/t1.6435-9/153851442_3754978591285691_1650931724252815520_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=eZ8Jgg3rGK0AX9QGmzW&_nc_ht=scontent.fdad3-2.fna&oh=8e6d44cc06dbc09c08984069ca599a78&oe=613FA2D3" alt="">Admin
							</a>
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<form:form method="post" action="doNewAccount"
						modelAttribute="user" style="margin-left: 183px; margin-right: -739px; ">
						...
						<div class="form-group row">
							<div class="col-sm-offset-2 col-sm-12">
								<input style="margin-left: 385px; width: 150px;" type="submit"
