				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.6435-9/177663046_1237481923335304_2827885514658087735_n.jpg?_nc_cat=111&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=1Y1LY20086oAX_22MQ2&_nc_ht=scontent-sin6-1.xx&oh=5d3ebb384fa470c4d03bacd37f9684e6&oe=613EFD49" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.6435-9/177663046_1237481923335304_2827885514658087735_n.jpg?_nc_cat=111&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=1Y1LY20086oAX_22MQ2&_nc_ht=scontent-sin6-1.xx&oh=5d3ebb384fa470c4d03bacd37f9684e6&oe=613EFD49" alt="">Staff
							</a>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3 class="text-capitalize">Quản Lý Địa Điểm</h3>
						</div>
						...
						<div class="x_panel">
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									...
									<a href="${pageContext.request.contextPath}/staff/addAddress"
										class="btn btn-primary btn-sm" data-whatever="@mdo"><i
										class="fa fa-plus"></i> Thêm Địa Điểm </a>
									<a href="${pageContext.request.contextPath}/staff/addCity"
										class="btn btn-primary btn-sm" data-whatever="@mdo"><i
										class="fa fa-plus"></i> Thêm Thành phố </a>
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
												...
												<th class="column-title">Tên Địa Điểm</th>
                              ...
                              <a class="antoo" style="color:#fff; font-weight:500;">( <span class="action-cnt"> </span> ) <i class="fa fa-chevron-down"></i></a>
										...
										<tbody>
											...
											<c:choose>
												<c:when
													test="${listAdress !=null && listAdress.size() gt 0}">
													<c:forEach items="${listAdress }" var="item">
												...
												<td class="last"><a href="#"
													class="btn btn-primary btn-sm"> <i
														...
														class="fa fa-close"></i>
															...
															<td>${item.id }</td>
															<td>${item.nameAddress }</td>
															<td>${item.description }</td>
															<td><img
																src="${pageContext.request.contextPath}/image/${item.urlImageAddress}" />
															</td>
															<td>${item.cityEntity.nameCity }</td>
															<td class="last"><a
																href="updateAddress?id=${item.id }"
																class="btn btn-primary btn-sm"> <i
																	class="fa fa-refresh"></i>
															</a> <a href="deleteAddress?id=${item.id }"
