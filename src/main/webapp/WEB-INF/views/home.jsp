		...
		<div class="container" style="margin-bottom: 100px">
			<div class="row">
				<div class="col-12 col-md-12">
					...
					<div class="row m-2">
						<div class="col-md-12 col-6">
							<div class="card hovercard">
								...
								<div class="avatar">
									<img alt=""
										src="https://scontent.fsgn2-6.fna.fbcdn.net/v/t1.18169-9/22007424_523036551367239_7409671042221959504_n.jpg?_nc_cat=110&ccb=1-4&_nc_sid=174925&_nc_ohc=FvlxzzFLkHgAX-TsxyY&_nc_ht=scontent.fsgn2-6.fna&oh=1c4aaaccdf0166e2f03aaa9630377be6&oe=6137EE74" />
								</div>
								<div class="info">
									<div class="title">
										<a target="_blank" href="#" style="text-decoration: none">Sơn
											Kê</a>
									</div>
									<div class="desc">Developer</div>
								</div>
					...
					<div class="row m-2">
						<div class="col-md-12 col-6">
							<div class="card hovercard">
								...
								<div class="avatar">
									<img alt=""
										src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/56848105_124251112078583_4939901174305259520_n.jpg?_nc_cat=108&ccb=1-4&_nc_sid=8bfeb9&_nc_ohc=ccZNtt-eueAAX_rGMni&_nc_ht=scontent.fdad3-3.fna&oh=961db03d395836c6cf70794ce15c9c01&oe=613792E6" />
								</div>
								<div class="info">
									<div class="title">
										<a target="_blank" href="#"
											style="text-decoration: none; font-size: 20px">Chu Nguyên
											Chương</a>
									</div>
									<div class="desc">Developer</div>
								</div>
					...
					<div class="row m-2">
						<div class="col-md-12 col-6">
							<div class="card hovercard">
								...
								<div class="avatar">
									<img alt=""
										src="https://scontent.fhph1-2.fna.fbcdn.net/v/t1.6435-9/c0.37.686.686a/s851x315/126177752_2841279196154560_8915718203692881655_n.jpg?_nc_cat=109&ccb=1-4&_nc_sid=da31f3&_nc_ohc=cLWyYz8plwkAX9mfDJD&_nc_ht=scontent.fhph1-2.fna&oh=daa24edc66b2970a30da80422da7d5c3&oe=6137D186" />
								</div>
								<div class="info">
									<div class="title">
										<a target="_blank" href="#" style="text-decoration: none">Hồ
											Quang Hiếu</a>
									</div>
									<div class="desc">Developer</div>
								</div>
					...
					<div class="row m-2">
						<div class="col-md-12 col-6">
							<div class="card hovercard">
								...
								<div class="avatar">
									<img alt=""
										src="https://scontent.fhan3-3.fna.fbcdn.net/v/t1.6435-9/150558997_1515954608610234_6523199005405362722_n.jpg?_nc_cat=111&ccb=1-4&_nc_sid=09cbfe&_nc_ohc=YfhYm7opnGcAX8ZQNM3&_nc_ht=scontent.fhan3-3.fna&oh=08ab069a9dbf1eaed1fb622359da290f&oe=613AA2B1" />
								</div>
								<div class="info">
									<div class="title">
										<a target="_blank" href="#" style="text-decoration: none">Tuấn
											Hưng</a>
									</div>
									<div class="desc">Developer</div>
								</div>
					...
					<div class="row m-2">
						<div class="col-md-12 col-6">
							<div class="card hovercard">
								...
								<div class="avatar">
									<img alt=""
										src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/217389779_1685253284998861_1944965444293810435_n.jpg?_nc_cat=108&ccb=1-4&_nc_sid=09cbfe&_nc_ohc=DD2s8K6fyjsAX8r05eP&_nc_ht=scontent.fdad3-3.fna&oh=7135fbb5f98c3b388b157e1676d40e00&oe=61386688" />
								</div>
								<div class="info">
									<div class="title">
										<a target="_blank" href="#" style="text-decoration: none">Chu
											Bá Thông</a>
									</div>
									<div class="desc">Developer</div>
								</div>
					...
					<!-- 		<div class="row m-2">
							<div class="col-md-12 col-6">
								<div style="margin-left: 150px" class="col-md-12 col-8 card hovercard">
									<div class="cardheader"></div>
									<div class="avatar">
										<img alt=""
											src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/56848105_124251112078583_4939901174305259520_n.jpg?_nc_cat=108&ccb=1-4&_nc_sid=8bfeb9&_nc_ohc=ccZNtt-eueAAX_rGMni&_nc_ht=scontent.fdad3-3.fna&oh=961db03d395836c6cf70794ce15c9c01&oe=613792E6" />
					...
					<div class="col-12 d-flex flex-wrap">
						...
						<ul>
							...
							<li><a class="text-secondary" href="#">Điều kiện & Điều
									khoản</a></li>
							<li><a class="text-secondary" href="#">Quy chế hoạt động</a></li>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4">
						<ul>
							...
							<li><a href="#" class="text-warning" style="font-size: 20px"><i
									class="fas fa-phone-alt"></i> 1900 2045</a></li>
