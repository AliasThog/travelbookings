				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.6435-9/202800258_326992695787520_8183699490161190532_n.jpg?_nc_cat=107&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=HXCePLUl1QgAX-Lbxmy&_nc_ht=scontent-sin6-1.xx&oh=235e114c3afb10c3c7bb7bc8324136c5&oe=613D72E2" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.6435-9/202800258_326992695787520_8183699490161190532_n.jpg?_nc_cat=107&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=HXCePLUl1QgAX-Lbxmy&_nc_ht=scontent-sin6-1.xx&oh=235e114c3afb10c3c7bb7bc8324136c5&oe=613D72E2" alt="">Staff
							</a>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3 class="text-capitalize">Quản Lý Service và Khuyến mãi</h3>
						</div>
						...
						<div class="title_right">
							...
							<%-- 	<div class="form-group row">
									<form action="doSearch1" method="get">
										<input name="keyword" type="text" style="width: 229px"
						...
						<div class="x_panel">
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									...
									<a href="addService" class="btn btn-primary btn-sm"
										data-whatever="@mdo"><i class="fa fa-plus"></i> Thêm
										Service và Khuyến mãi </a>
										<a href="addPromotion" class="btn btn-primary btn-sm"
										data-whatever="@mdo"><i class="fa fa-plus"></i> Thêm Khuyến mãi </a>	
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
												...
												<th class="column-title">Tên service</th>
												<th class="column-title">Giá</th>
												<th class="column-title">Mô tả</th>
												<th class="column-title">Tên khuyến mãi</th>
												<th class="column-title">Phần trăm khuyến mãi</th>
                              ...
                              <a class="antoo" style="color:#fff; font-weight:500;">( <span class="action-cnt"> </span> ) <i class="fa fa-chevron-down"></i></a>
										...
										<tbody>
											...
											<c:choose>
												<c:when
													test="${listService != null && listService.size() gt 0}">
													<c:forEach items="${listService }" var="item">
														<tr class="even pointer">
															...
															<td>${item.price }</td>
															<td>${item.mota }</td>
															<td>${item.promotionEntity.name }</td>
															<td>${item.promotionEntity.percentage }</td>
