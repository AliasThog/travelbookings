				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img
								src="https://scontent.fdad3-1.fna.fbcdn.net/v/t1.6435-9/209635676_2493318084132324_2551917488035635449_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=A5IsFAlv7cIAX80lbg7&_nc_ht=scontent.fdad3-1.fna&oh=63b866d575ae000d2bc0fc9aa5f5696b&oe=613F0506"
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Thêm Khuyến Mãi</h3>
					...
					<form:form method="post" action="doAddPromotion"
						modelAttribute="promotion1"
						style="margin-right: -627px;
    margin-left: 196px;">
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Phần
								trăm</label>
							<div class="col-4 mb-4">

								<form:input path="percentage" type="text"
						...
						<div class="col-sm-offset-2 col-sm-12">
							...
							<input style="margin-left: 331px; width: 150px;" type="submit"
