				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img
								src="https://scontent.fdad3-2.fna.fbcdn.net/v/t1.6435-9/168980244_2426610420803091_6192286064037839354_n.jpg?_nc_cat=101&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=9FypGXlqxA0AX_bG3oB&tn=93qchO_iMVXbR0he&_nc_ht=scontent.fdad3-2.fna&oh=a00610b4e2e1b69b0500c3df9438291e&oe=613FC618"
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Thêm Service</h3>
					...
					<form:form method="post" action="doAddService"
						modelAttribute="service"
						style="margin-right: -359px; margin-left: 341px;">
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="nameService" type="text"
									cssClass="form-control" />
								<form:errors path="nameService" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Giá</label>
							<div class="col-4 mb-4">

								<form:input path="price" type="text" cssClass="form-control" />
								<form:errors path="price" cssClass="error" />
							</div>
						</div>
							<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Mô tả</label>
							<div class="col-4 mb-4">
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:select path="promotionEntity.id" cssClass="form-control">
									<form:option value="0">---Select Khuyến mãi---</form:option>
						...
						<div class="col-sm-offset-2 col-sm-12">
							<input style="margin-left: 252px; width: 150px;" type="submit"
								value="Thêm" class="btn btn-primary" />
								</div>
					</form:form>
					<a style="font-size: 20px" href="staffService">Return Quản lý
						Service</a>
				</div>
			</div>
		</div>
