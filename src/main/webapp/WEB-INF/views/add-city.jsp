		...
		<div class="main_container">
				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img
								src="https://scontent-sin6-2.xx.fbcdn.net/v/t1.6435-1/c0.27.160.160a/p160x160/188785728_1420700891606515_6116817118608958518_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=7206a8&_nc_ohc=3zi3AOmVelYAX-FRwVD&_nc_ht=scontent-sin6-2.xx&oh=a21c6e2ef091a75f82ce90815c7f9f62&oe=613E0DD6"
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<form:form method="post" action="doAddCity"
						enctype="multipart/form-data" modelAttribute="city1"
						style="margin-right: -508px; margin-left: 194px;">
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="nameCity" type="text" cssClass="form-control" />
								<form:errors path="nameCity" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Quận
							</label>
							<div class="col-4 mb-4">

								<form:input path="district" type="text" cssClass="form-control" />
								<form:errors path="district" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Tỉnh
							</label>
							<div class="col-4 mb-4">

								<form:input path="nameProvince" type="text"
									cssClass="form-control" />
								<form:errors path="nameProvince" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Phường
							</label>
							<div class="col-4 mb-4">

								<form:input path="wards" type="text" cssClass="form-control" />
								<form:errors path="wards" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
