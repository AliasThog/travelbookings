				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://justbiography.com/wp-content/uploads/2020/06/ngoc-trinh-5-1572423107231301246873-crop-15724237122011649225014.jpg" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://justbiography.com/wp-content/uploads/2020/06/ngoc-trinh-5-1572423107231301246873-crop-15724237122011649225014.jpg" alt="">Staff
							</a>
						...
						<div class="title_right">
							<div class="col-md-5 col-sm-5   form-group pull-right top_search"
								...
								<div class="form-group row">
									<form action="${pageContext.request.contextPath}/staff/doSearch" method="get">
						...
						<div class="x_panel">
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
												...
												<th class="column-title">Cách trung tâm</th>
												<th class="column-title">Mô tả</th>
												<th class="column-title">Đánh giá</th>
												<th class="column-title">Hình ảnh</th>
												<th class="column-title">Tên Địa Điểm</th>
												<th class="column-title">Mô tả địa điểm</th>
												<th class="column-title">Loại khách sạn</th>
												<th class="column-title">Mô tả</th>
												...
												<td class="last"><a href="#"
													class="btn btn-primary btn-sm"> <i
														...
														class="fa fa-close"></i>
															...
															<td>${item.hotelTypeEntity.name }</td>
															<td>${item.hotelTypeEntity.description }</td>
