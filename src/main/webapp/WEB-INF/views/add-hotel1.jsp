				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent-hkg4-1.xx.fbcdn.net/v/t1.6435-9/203755065_1450444995298771_54186728382646619_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=0debeb&_nc_ohc=H5IcY8FJqDwAX-Skhnp&_nc_ht=scontent-hkg4-1.xx&oh=97a1bcfaa6a29f17cdc5aba5e201ab60&oe=61406DB3" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent-hkg4-1.xx.fbcdn.net/v/t1.6435-9/203755065_1450444995298771_54186728382646619_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=0debeb&_nc_ohc=H5IcY8FJqDwAX-Skhnp&_nc_ht=scontent-hkg4-1.xx&oh=97a1bcfaa6a29f17cdc5aba5e201ab60&oe=61406DB3" alt="">Staff
							</a>
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Thêm Khách Sạn</h3>
					...
					<form:form method="post" action="doAddHotel"
						enctype="multipart/form-data" modelAttribute="hotel1"
						style="margin-right: -580px; margin-left: 212px;">
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Dia
								chi :</label>
							<div class="col-4 mb-4">
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Cách
								trung tâm</label>
							<div class="col-4 mb-4">

								<form:input path="cachTrungTam" type="text"
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Mô
								tả</label>
							<div class="col-4 mb-4">
								<form:textarea path="moTa" type="text" cssClass="form-control" />
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Đánh
								giá</label>
							<div class="col-4 mb-4">

								<form:input path="danhGia" type="text" cssClass="form-control" />
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="dichvu" type="text" cssClass="form-control" />
								<form:errors path="dichvu" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Dịch
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="dichvu1" type="text"
									cssClass="form-control" />
								<form:errors path="dichvu1" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Dịch
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="dichvu2" type="text"
									cssClass="form-control" />
								<form:errors path="dichvu2" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Dịch
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="dichvu3" type="text"
									cssClass="form-control" />
								<form:errors path="dichvu3" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Combo
							</label>
							<div class="col-4 mb-4">

								<form:textarea path="combo" type="text" cssClass="form-control" />
								<form:errors path="combo" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:select path="addressEntity.id" cssClass="form-control">
									<form:option value="0">---Select Loại Địa Điểm---</form:option>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:select path="hotelTypeEntity.id" cssClass="form-control">
									<form:option value="0">---Select Loại Khách Sạn---</form:option>
									<c:forEach items="${hotelType }" var="item">
						...
						<div class="col-sm-offset-2 col-sm-12">
							<input style="margin-left: 320px; width: 150px;" type="submit"
								value="Thêm" class="btn btn-primary" />
						</div>
					</form:form>
					<a style="font-size: 20px" href="hotelAdmin">Return Quản lý
						Khách Sạn</a>
				</div>
			</div>
		</div>
