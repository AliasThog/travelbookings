				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent.fdad3-2.fna.fbcdn.net/v/t1.6435-9/130096900_3715126111881228_247405928356412617_n.jpg?_nc_cat=101&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=uJL-0i0tLn8AX_z6tu5&_nc_ht=scontent.fdad3-2.fna&oh=866a97106b3a30af146e6814f34f4112&oe=6141ACFB" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent.fdad3-2.fna.fbcdn.net/v/t1.6435-9/130096900_3715126111881228_247405928356412617_n.jpg?_nc_cat=101&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=uJL-0i0tLn8AX_z6tu5&_nc_ht=scontent.fdad3-2.fna&oh=866a97106b3a30af146e6814f34f4112&oe=6141ACFB" alt="">Staff
							</a>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3 class="text-capitalize">Quản Lý Khuyến mãi</h3>
						</div>
							...
							<div class="x_content">
                              ...
                              <a class="antoo" style="color:#fff; font-weight:500;">( <span class="action-cnt"> </span> ) <i class="fa fa-chevron-down"></i></a>
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${promotion != null && promotion.size() gt 0}">
