				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img
								src="https://scontent-sin6-1.xx.fbcdn.net/v/t1.6435-9/97814047_922733424836366_2042852240305160192_n.jpg?_nc_cat=107&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=b4UHPU42dDUAX8DLTde&_nc_ht=scontent-sin6-1.xx&oh=efb2563b5c6cc60e5e38c4b3b780b0ff&oe=613F0C84"
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Thêm Tour mới</h3>
					...
					<form:form method="post" action="doAddTour"
						enctype="multipart/form-data" modelAttribute="tour1"
						style="margin-right: -523px; margin-left: 236px;">

						<c:if test="${message1 != null }">
							<span class="error"><c:out value="${message1 }"></c:out></span>
						</c:if>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">ID
								TOUR :</label>
							<div class="col-4 mb-4">

								<form:input path="idtour" type="text" cssClass="form-control" />
								<form:errors path="idtour" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Lịch
								trình :</label>
							<div class="col-4 mb-4">

								<form:input path="schedule" type="text" cssClass="form-control" />
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="nameTour" type="text" cssClass="form-control" />
								<form:errors path="nameTour" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Tên
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Vehicle:
							</label>
							<div class="col-4 mb-4">

								<form:input path="vehicle" type="text" cssClass="form-control" />
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="descriptionChitiet" type="text"
									cssClass="form-control" />
								<form:errors path="descriptionChitiet" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Evaluate:
							</label>
							<div class="col-4 mb-4">

								<form:input path="evaluate" type="text" cssClass="form-control" />
								<form:errors path="evaluate" cssClass="error" />
							</div>
						</div>

						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Feedback:
							</label>
							<div class="col-4 mb-4">

								<form:input path="feedback" type="text" cssClass="form-control" />
								<form:errors path="feedback" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Status:
							</label>
							<div class="col-4 mb-4">
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Trải
								Nghiệm </label>
							<div class="col-4 mb-4">

								<form:textarea path="traiNghiem" type="text"
									cssClass="form-control" />
								<form:errors path="traiNghiem" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Trải
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="traiNghiem1" type="text"
									cssClass="form-control" />
								<form:errors path="traiNghiem1" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Trải
							...
							<div class="col-4 mb-4">
								...
								<form:textarea path="traiNghiem2" type="text"
									cssClass="form-control" />
								<form:errors path="traiNghiem2" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="tienIch" type="text" cssClass="form-control" />
								<form:errors path="tienIch" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Tiện
							...
							<div class="col-4 mb-4">
								...
								<form:input path="tienIch1" type="text" cssClass="form-control" />
								<form:errors path="tienIch1" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="tienIch2" type="text" cssClass="form-control" />
								<form:errors path="tienIch2" cssClass="error" />
							</div>
						</div>


						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Chương
								trình Tour Ngày 1 </label>
							<div class="col-4 mb-4">

								<form:textarea path="chuongtrinhtour1" type="text"
									cssClass="form-control" />
								<form:errors path="chuongtrinhtour1" cssClass="error" />
							</div>
						</div>

						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Chương
								trình Tour Ngày 2 </label>
							<div class="col-4 mb-4">

								<form:textarea path="chuongtrinhtour2" type="text"
									cssClass="form-control" />
								<form:errors path="chuongtrinhtour2" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Chương
								trình Tour Ngày 3 </label>
							<div class="col-4 mb-4">

								<form:textarea path="chuongtrinhtour3" type="text"
									cssClass="form-control" />
								<form:errors path="chuongtrinhtour3" cssClass="error" />
							</div>
						</div>

						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Chương
								trình Tour Ngày 4 </label>
							<div class="col-4 mb-4">

								<form:textarea path="chuongtrinhtour4" type="text"
									cssClass="form-control" />
								<form:errors path="chuongtrinhtour4" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:select path="addressEntity.id" cssClass="form-control">
									<form:option value="0">---Select Dia Diem---</form:option>
									<c:forEach items="${address1 }" var="item">
										<form:option value="${item.id }">${item.nameAddress }</form:option>
									</c:forEach>
								</form:select>
							</div>
						</div>
						...
						<div class="col-sm-offset-2 col-sm-12">
							<input style="margin-left: 300px; width: 150px;" type="submit"
								value="Thêm" class="btn btn-primary" />
						</div>
					</form:form>
					<a style="font-size: 20px" href="tourAdmin">Return list</a>
				</div>
			</div>
		</div>
		<!-- /page content -->
