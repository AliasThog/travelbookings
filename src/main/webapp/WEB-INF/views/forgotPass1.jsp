	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-xl-12 p-0">
				<div class="content-reset card">
					<form class="card-body mx-auto mt-5" action="" method="POST"
						...
						<div class="form-group">
							<a href="./forgot_password_two.html" type="submit"
								class="btn btn-blue btn-block"> Reset my Password </a>
						</div>
						<p class="text-center">
							or you can <a href="./login.html"> create a new account </a>
						</p>
					</form>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-12 d-flex flex-wrap">
							...
							<ul>
								...
								<li><a class="text-secondary" href="#">Điều
										kiện & Điều khoản</a></li>
							...
							<ul>
								...
								<li><a class="text-secondary" href="#">Quy
										chế bảo hiểm Cathay</a></li>
								<li><a class="text-secondary" href="#">Yêu
										cầu bồi thường Cathay</a></li>
