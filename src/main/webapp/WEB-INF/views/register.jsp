	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-xl-12 p-0">
				<div class="content">
					<form:form cssClass="register" action="doRegister" method="post"
						modelAttribute="user">
						<div class="card bg-light">
							<article class="card-body mx-auto" style="width: 500px">
								<h4 class="card-title mt-3 mb-4 text-center">Đăng ký</h4>
								<p>
								...
								<div class="form-group input-group">
									...
									<form:input path="email" style="width:100%" placeholder="Email"
								...
								<div class="form-group input-group">
									...
									<form:input path="username" placeholder="UserName"
										style="width:100%" ccsClass="form-control" />
