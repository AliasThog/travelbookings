				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent-sin6-3.xx.fbcdn.net/v/t1.6435-9/125245237_1137775089972655_7460942610848606203_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=L65iKTKvYGYAX_dx5KB&tn=93qchO_iMVXbR0he&_nc_ht=scontent-sin6-3.xx&oh=f2e0d80d07d129a0c2270c304bed276e&oe=613D04D3" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent-sin6-3.xx.fbcdn.net/v/t1.6435-9/125245237_1137775089972655_7460942610848606203_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=L65iKTKvYGYAX_dx5KB&tn=93qchO_iMVXbR0he&_nc_ht=scontent-sin6-3.xx&oh=f2e0d80d07d129a0c2270c304bed276e&oe=613D04D3" alt="">Staff
							</a>
						...
						<div class="x_panel">
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									...
									<a href="addTourPrice" class="btn btn-primary btn-sm"
										...
										Tour </a>
									<a href="tourPriceAdmin" class="btn btn-primary btn-sm"
										data-whatever="@mdo"><i class="fa fa-plus"></i>Quản lí giá
										tour</a>
								</ul>
								<div class="clearfix"></div>
							</div>
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
												...
												<th class="column-title">ID Tour</th>
												<th class="column-title">Lịch trình</th>
												<th class="column-title">Tên Tour</th>
												<th class="column-title">Địa điểm</th>
												<th class="column-title">Phương tiện di chuyển</th>
												<th class="column-title">Mô Tả</th>
												<th class="column-title">URL Image</th>
												<th class="column-title">Evaluate</th>
                              ...
                              <a class="antoo" style="color:#fff; font-weight:500;">( <span class="action-cnt"> </span> ) <i class="fa fa-chevron-down"></i></a>
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${listTour !=null && listTour.size() gt 0}">
												...
												<td class="last"><a href="#"
													class="btn btn-primary btn-sm"> <i
														...
														class="fa fa-close"></i>
															...
															<td class="last"><a href="updateTour?id=${item.id }"
																class="btn btn-primary btn-sm"> <i
																	class="fa fa-refresh"></i>
															</a> <a href="deleteTour?id=${item.id }"
