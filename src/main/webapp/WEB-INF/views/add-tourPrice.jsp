				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/166404844_1153214908454882_1499270138131158848_n.jpg?_nc_cat=108&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=8zgp8qgX6S8AX-4BkCo&_nc_ht=scontent.fdad3-3.fna&oh=83d716846fee55dfca4a16bcb4e33a6f&oe=613E6D79" alt="..."
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/166404844_1153214908454882_1499270138131158848_n.jpg?_nc_cat=108&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=8zgp8qgX6S8AX-4BkCo&_nc_ht=scontent.fdad3-3.fna&oh=83d716846fee55dfca4a16bcb4e33a6f&oe=613E6D79" alt="">Staff
							</a>
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Thêm giá tour</h3>
						</div>
					</div>
					...
					<form:form method="post" action="doAddTourPrice"
						enctype="multipart/form-data" modelAttribute="tourPrice1" style="margin-right: -897px; margin-left: 179px;">

						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Time
								Date Start:</label>
							<div class="col-4 mb-4">

								<form:input path="timeDateStart" type="date"
									cssClass="form-control" />
								<form:errors path="timeDateStart" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Time
							...
							<div class="col-4 mb-4">
								...
								<form:input path="timeDateEnd" type="date"
									cssClass="form-control" />
								<form:errors path="timeDateEnd" cssClass="error" />
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="timeDate" type="text" cssClass="form-control" />
								<form:errors path="timeDate" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="priceTour" type="text" cssClass="form-control" />
								<form:errors path="priceTour" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:input path="priceTourChildren" type="text"
									cssClass="form-control" />
								<form:errors path="priceTourChildren" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">DiscountPromotion
								: </label>
							<div class="col-4 mb-4">

								<form:input path="discountPromotion" type="text"
									cssClass="form-control" />
								<form:errors path="discountPromotion" cssClass="error" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:select path="tourEntity.id" cssClass="form-control">
									<form:option value="0">---Select Tour---</form:option>
									<c:forEach items="${tour1 }" var="item">
										<form:option value="${item.id }">${item.nameTour }</form:option>
									</c:forEach>
								</form:select>
							</div>
						</div>
...
<input style="margin-left: 380px; width: 150px;" type="submit"
value="Thêm" class="btn btn-primary" />
</div>
					</form:form>
					<a style="font-size: 20px" href="tourPriceAdmin">Return list</a>
				</div>
			</div>
		</div>
		<!-- /page content -->
